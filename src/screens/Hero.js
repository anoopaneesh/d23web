...
const Hero = () => {
  return (
    <>
      ...
      <div className='bg-[rgba(0,0,0,.5)] w-full h-screen absolute top-0'></div>
      <div className='overflow-hidden mt-40 z-20 relative'>

        <h1 className="text-center glitch no_drag text-8xl font-bold italic text-white" data-text="DYUKSHA '23">DYUKSHA&nbsp;'23</h1>
        <h3 className='text-center text-foreground text-xl mt-10'>THE TECHNO-CULTURAL PROTAGONIST SHALL RISE AGAIN</h3>
