  ...
  return (
    <>
      ...
      <div className='relative top-0 overflow-hidden z-2 h-screen'>
        <img src={bg_loop} className="absolute top-0 w-full h-full object-cover" />
        ...
        <div className='mt-[30%] md:mt-20'>
          ...
          <h3 className='text-center text-foreground text-sm md:text-xl mt-4 md:mt-10 relative'>THE TECHNO-CULTURAL PROTAGONIST SHALL RISE AGAIN</h3>
