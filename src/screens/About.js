...
const About = () => {
    return (
        <>
            <div className='absolute  w-full h-72 bg-gradient-to-t from-transparent to-[#050505]'></div>
                ...
                <div className='flex justify-center pb-40 text-foreground about'>
                    <div className='px-8 md:p-0 w-full md:w-2/3 mt-5 md:mt-40'>
                        <div className='text-4xl md:text-7xl text-heading mb-8 font-bold flex justify-start items-center'>
                            ...
                            <p className='text-transparent text_stroke font-bold'>'23</p>
                        </div>
                        <p className='text-justify text-md md:text-xl pt-8'>Palakkad has increasingly fantastic things tucked away among its fold of the Western Ghats other than the Silent Valley National Park, and among those things is the NSS College of Engineering. It is best described as a place that is bordered by verdurous mountains, rather than walls, where youngsters from all over the state work and live together as a vibrant community. As opposed to portraying it as a scholarly organization, it is best depicted by the name its students gave - Shangri La, Heaven on Earth.
                            <br /><br />
