                        ...
                        <div className='w-[96%] h-[100%] flex flex-col md:flex-row'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='flex justify-center space-x-4 px-4 pb-4 md:pt-0 pt-8'>
                                    ...
                                    <a href={selected.ticket} target="_blank" rel="noreferrer" className='text-center'><button className=' bg-[#36fdfd] proshow_button font-chakra' type="button" style={{
                                        background
                    ...
                    <div className="proshows md:space-y-0 space-y-8">
                        <div className="container-shows">
                            ...
                            <div className="content-container">
                                ...
                                <div className='text-center' onClick={() => openDay(1)}><button className=' bg-[#36fdfd] proshow_button font-chakra' type="button" style={{
                                    background
                        ...
                        <div className="container-shows">
                            ...
                            <div className="content-container">
                                ...
                                <div className='text-center' onClick={() => openDay(3)}><button className='bg-[#36fdfd] proshow_button day3_button font-chakra ' type="button" style={{
                                    background
